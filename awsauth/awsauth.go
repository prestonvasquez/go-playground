...
// Register replaces the driver's built-in MONGODB-AWS authenticator factory
// with one backed by aws-sdk-go-v2.
func Register() {
	auth.RegisterAuthenticatorFactory(auth.MongoDBAWS, NewAuthenticator)
}
...
// NewAuthenticator creates a new AWS SDK authenticator.
